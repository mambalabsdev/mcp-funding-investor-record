...
server.registerTool("get_company_funding_record", {
    ...
    return runActor("OFS4Mt1gyYNtGfUbE", "Funding Record from SEC and Companies House", compact({
        company_domain,
        company_name,
        sources,
        lookbackMonths,
